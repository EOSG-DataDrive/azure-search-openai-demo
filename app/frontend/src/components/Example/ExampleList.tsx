...
const SituationalAwarenessExamples: ExampleModel[] = [
  ...
  {
    text: "Describe the main events regarding the Cholera outbreak in Haiti.",
    value: "Describe the main events regarding the Cholera outbreak in Haiti."
  },
  {
    text: "Describe the main events regarding the Cholera outbreak in Haiti.",
    value: "Describe the main events regarding the Cholera outbreak in Haiti."
  ...
  export const ExampleList = ({ onExampleClicked }: Props) => {
    ...
    return (
      <div className={styles.dropdownContainer}>
        <div
          className={`${styles.dropdown} ${isSituationalAwarenessExpanded ? "active" : ""}`}
          onClick={toggleSituationalAwareness}
          tabIndex={0}
        >
        ...
        <div
          className={`${styles.dropdown} ${isIntegratedReportsExpanded ? "active" : ""}`}
          onClick={toggleIntegratedReports}
          tabIndex={0}
        >
        ...
        <div
          className={`${styles.dropdown} ${isThirdCategoryExpanded ? "active" : ""}`}
          onClick={toggleThirdCategory}
          tabIndex={0}
        >
